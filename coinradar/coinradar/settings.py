"""
Django settings for coinradar project.
...
WSGI_APPLICATION = 'coinradar.wsgi.application'
...
TOP_COINS_CACHE_KEY = 'top_100_coins'

CACHES = {
    "default": {
        "BACKEND": "django_redis.cache.RedisCache",
        "LOCATION": os.getenv("CELERY_CACHE_URL"),  
        "OPTIONS": {
